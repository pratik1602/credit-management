...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('first_name', 'last_name', 'phone_no', 'aadhar','aadhar_status','pan','pan_status','cheque','cheque_status','otp' ,'refer_code','referred_by','tc', 'commission_status', 'modified_by', 'created_by'  )}),
...
class CardsAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        obj.commission_total_amount = round(obj.commission_total_amount, 2)
