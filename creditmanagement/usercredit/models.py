...
class User(AbstractBaseUser):
    ...
    aadhar = models.ImageField(upload_to='uploads/Aadhar/',default="")
    aadhar_status = models.BooleanField(default=False)
    pan = models.ImageField(upload_to='uploads/pan/',default="")
    pan_status = models.BooleanField(default=False)
    cheque = models.ImageField(upload_to='uploads/cheque/',default="")
